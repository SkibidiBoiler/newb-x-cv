...
#define NL_CONSTRAST 0.6             // 0.3 low ~ 2.0 high
#define NL_EXPOSURE 0.8              // [toggle] 0.5 dark ~ 3.0 bright
#define NL_SATURATION 1.15          // [toggle] 0.0 grayscale ~ 4.0 super saturated
//#define NL_TINT vec3(0.98,0.66,0.18)   // [toggle] color overlay

/* Terrain lighting */
#define NL_SUN_INTENSITY 1.9   // 0.5 weak ~ 5.0 bright
#define NL_TORCH_INTENSITY 0.7  // 0.5 weak ~ 3.0 bright
...
#define NL_MORNING_SUN_COL vec3(0.99,0.35,0.12)
#define NL_NOON_SUN_COL    vec3(1.0,0.40,0.57)
#define NL_NIGHT_SUN_COL   vec3(0.5,0.64,1.00)

/* Ambient light on terrain (light that is added everywhere) */
#define NL_NETHER_AMBIENT vec3(4.0,0.33,0.33)
#define NL_END_AMBIENT vec3(0.97,0.01,0.81)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(0.94,0.20,0.00)
#define NL_UNDERWATER_TORCH_COL vec3(0.94,0.20,0.00)
#define NL_NETHER_TORCH_COL     vec3(0.59,0.31,0.98)
#define NL_END_TORCH_COL        vec3(0.94,0.20,0.00)

/* Fog */
#define NL_FOG_TYPE 2             // 0:no fog, 1:vanilla, 2:smoother vanilla
#define NL_MIST_DENSITY 2.5       // 0.0 no mist ~ 1.0 misty
#define NL_RAIN_MIST_OPACITY 0.6  // [toggle] 0.04 very subtle ~ 0.5 thick rain mist blow

/* Sky colors - zenith=top, horizon=bottom */
#define NL_DAY_ZENITH_COL    vec3(0.05,1.43,2.00)
#define NL_DAY_HORIZON_COL   vec3(0.90,0.75,0.87)
#define NL_NIGHT_ZENITH_COL  vec3(0.004,0.024,0.15)
#define NL_NIGHT_HORIZON_COL vec3(0.01,0.06,0.10)
#define NL_RAIN_ZENITH_COL   vec3(0.19,0.32,0.50)
#define NL_RAIN_HORIZON_COL  vec3(1.0,1.0,1.0)
#define NL_END_ZENITH_COL    vec3(0.7,0.10,1.4)
#define NL_END_HORIZON_COL   vec3(0.2,0.08,5.0)
#define NL_DAWN_ZENITH_COL   vec3(0.015,0.045,0.1)
#define NL_DAWN_HORIZON_COL  vec3(1.00,0.48,0.00)
...
#define NL_GLOW_LEAK 0.9 // [toggle] 0.08 subtle ~ 1.0 100% brightness of NL_GLOW_TEX
...
#define NL_CAUSTIC_INTENSITY 1.3     // 0.5 weak ~ 5.0 bright
#define NL_UNDERWATER_WAVE 0.35       // [toggle] 0.02 subtle ~ 0.6 trippy
...
#define NL_CLOUD2_DENSITY 23.0       // 1.0 blurry ~ 100.0 sharp
...
#define NL_AURORA_VELOCITY 0.11 // 0.0 static ~ 0.3 very fast
#define NL_AURORA_SCALE 0.11    // 0.002 large ~ 0.4 tiny
#define NL_AURORA_WIDTH 0.18    // 0.04 thin line ~ 0.4 thick lines
#define NL_AURORA_COL1 vec3(0.04,1.00,0.56)
#define NL_AURORA_COL2 vec3(0.01,0.22,0.82)
...
#define NL_GROUND_RAIN_WETNESS 0.7 // 0.0 no wetness ~ 1.0 fully wet blocks when raining
